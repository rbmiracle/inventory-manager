...
class FileView(object):
    ...
    def _get_item_attribute(self, prod_index, attribute):
        product = self._inventory.items.__getitem__(prod_index)
        if attribute == 0:
    ...
    def _print_product(self, id_selection=-1):
        #Implemented
        ...
        if product_id_in_inventory:
            ...
            return (self._print_line(id_selection))
        else:
            return( ">>> NO PRODUCT WITH SELECTED ID <<<")
            # self._print_file()
            # print(">>> NO PRODUCT WITH SELECTED ID <<<")
    ...
    def _add_product(self,product_manufacturer="Default", product_name="Default",
        ...
        return(self._print_line(str(product_id)))

    # remove a Product from CSV file based on Product ID or name
    def _remove_product(self, id_selection):
        ...
        to_return = self._print_line(id_selection)
    ...
    def _update_product(self, id_selection, new_id, new_manufacturer, new_name, new_cost, new_price,
        ...
        # while not product_id_in_inventory:
            ...
            # print("Selected ID not in Inventory.")
            # print()
        if(self._product_id_in_inventory(id_selection)):
        ...
        # DO NOT PASS THIS PRODUCT FOR REMOVAL FROM INVENTORY
            ...
            print()
            return str(self._print_line(updated_product.item_id))
        else:
